...
Create a playbook that installs and configures a Tomcat server on the **nodes** host group. Read the playbook and explain the different tasks containing it. Reference to the vagrant.zip file on Toledo. 
